...
from ..serializers.DoctorsListSerializer import DoctorsListSerializer, DoctorsListARSerializer
...
class DoctorsListView(generics.ListAPIView):  # All doctors list view
    ...
    def list(self, request, *args, **kwargs):
        ...
        if language == 'ar':
            serializer = DoctorsListARSerializer(page, many=True)
        else:
            serializer = DoctorsListSerializer(page, many=True)
