...
from .views.doctor_view import ReservationListView, ConfirmReservationView, RejectReservationView
...
urlpatterns = [
    ...
    path('reservation/<int:pk>/reject', RejectReservationView.RejectReservationView.as_view()),
